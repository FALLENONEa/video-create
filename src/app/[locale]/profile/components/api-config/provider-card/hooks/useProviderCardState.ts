...
export function buildProviderConnectionPayload(params: {
  ...
  const isCompatibleProvider =
    params.providerKey === 'openai-compatible' || params.providerKey === 'gemini-compatible' || params.providerKey === 'sub2api'
...
export function useProviderCardState({
  ...
  const showBaseUrlEdit =
    ['gemini-compatible', 'openai-compatible', 'sub2api', 'bailian'].includes(providerKey) &&
